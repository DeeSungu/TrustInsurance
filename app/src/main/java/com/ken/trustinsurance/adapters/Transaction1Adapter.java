...
public class Transaction1Adapter extends RecyclerView.Adapter<Transaction1Adapter.ViewHolder> {
    ...
    public Transaction1Adapter(Context context, List<TransactionModel> userList, Boolean isInChat){
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.sub.setText(user.getName());
